  ...
  return (
    <div className="bg-gradient-to-r from-white to-gray-100 dark:from-gray-800 dark:to-gray-900 backdrop-blur-md p-4 px-6 rounded-b-lg shadow-md flex justify-between items-center z-30">
      ...
      <div className="flex flex-row gap-4 items-center">
        ...
        <Button
          variant="outline"
          className="py-2 px-4 h-fit font-medium bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:opacity-90 flex items-center justify-center gap-2 rounded-lg border-none shadow-lg transition-all duration-300 ease-in-out"
        >
          <PhoneIcon />
        ...
        {session ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button className="py-2 px-3 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-full shadow transition-all duration-300 ease-in-out">
          ...
          <Button className="py-2 px-4 bg-blue-500 hover:bg-blue-600 text-white rounded-lg shadow-md transition-all duration-300 ease-in-out">
